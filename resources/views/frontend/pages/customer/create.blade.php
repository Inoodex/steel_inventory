...
<div class="content container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="content-page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h4 class="card-title fw-bold text-dark mb-1">Add New Customer</h4>
                <p class="text-muted small mb-0">Create a new customer profile for sales orders, billing, and invoices</p>
            </div>
            <div>
        ...
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('customers.store') }}">
                ...
                <div class="d-flex align-items-center justify-content-end gap-2 pt-3 border-top border-light">
                    ...
                    <button type="submit" class="btn btn-primary px-4 py-2 rounded-3 shadow-sm">Save Customer</button>
                </div>
