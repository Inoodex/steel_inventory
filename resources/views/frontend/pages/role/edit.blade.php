...
<div class="content container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="content-page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h4 class="card-title fw-bold text-dark mb-1">Edit Role: {{ $role->name }}</h4>
                <p class="text-muted small mb-0">Modify role title and update module access authorization</p>
            </div>
            <div>
    ...
    <form action="{{ route('role.update', $role->id) }}" method="POST">
        ...
        <div class="card border-0 shadow-sm rounded-3 mb-4">
            ...
            <div class="card-footer bg-light py-3 border-top d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary px-4 rounded-2">Update Role</button>
            </div>
        </div>
    </form>
</div>
