...
<div class="content container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="content-page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h4 class="card-title fw-bold text-dark mb-1">Edit Bank Account</h4>
                <p class="text-muted small mb-0">Update company bank account information and settings</p>
            </div>
            <div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" name="opening_balance" class="form-control border-light-subtle fw-semibold text-dark" value="{{ old('opening_balance', $bankDetail->opening_balance ?? '0.00') }}" placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="text" name="swift_code" class="form-control border-light-subtle font-monospace" value="{{ old('swift_code', $bankDetail->swift_code ?? '') }}" placeholder="e.g. CIBLBDDH">
                    </div>

                    <div class="col-md-6 col-12">
                        <label class="form-label small text-secondary fw-semibold mb-1">Account Notes / Remarks</label>
                        <input type="text" name="notes" class="form-control border-light-subtle" value="{{ old('notes', $bankDetail->notes ?? '') }}" placeholder="e.g. Operational expenses, wire disbursements">
                    </div>
