...
<div class="content container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="content-page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h4 class="card-title fw-bold text-dark mb-1">Create TA/DA Record</h4>
                <p class="text-muted small mb-0">Record travel & daily allowance advances or claims for employees</p>
            </div>
            <div>
            ...
            <form action="{{ route('ta-da.store') }}" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="date" name="date" class="form-control border-light-subtle" value="{{ old('date', date('Y-m-d')) }}" required>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="number" step="0.01" name="amount" class="form-control border-light-subtle" required>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <textarea name="purpose" class="form-control border-light-subtle" rows="3"></textarea>
                    </div>
                </div>

                <div class="d-flex justify-content-end gap-2 border-top pt-3">
                    <a href="{{ route('ta-da.index') }}" class="btn btn-outline-secondary px-4 rounded-3">Cancel</a>
                    <button type="submit" class="btn btn-primary px-4 rounded-3">Save Record</button>
                </div>
            </form>
        </div>
    </div>
